...
const Banner = () => {
    ...
    return (
        ...
        <img
          ...
          alt="banner"
          className="w-full   object-none xl:hidden block "
          style={{ height: "60vh" }}
        />
        <div className="absolute left-14  md:top-24 top-10  left  ">
          <p className="mb-2 text-gray-600">Get Yours</p>
          <p className=" lg:text-6xl w-3/4 text-4xl font-extrabold">
          Welcome to Capable Service - Your Trusted <span className=" text-primary ">HVAC</span>  Partner in New Jersey.
          </p>
    ...
    <Link  href={"/contact"}>
      <span className=" cursor-pointer  bg-green-600 hover:bg-green-500  py-4 lg:px-8 px-4 text-white text-medium text-center  border-4 border-black hover:text-black font-extrabold hover:shadow-buttonShadow shadow-black duration-300 ease-in-out  ">
      Get a quote
      </span>
      </Link>
      <Link  href={"/services"}>
