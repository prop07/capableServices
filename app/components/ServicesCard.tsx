...
const ServicesCard = () => {
  ...
  return (
    <div className='my-8'>
      ...
      <div className='grid xl:grid-cols-3 lg:grid-cols-2 sm:grid-cols-1 gap-3  w-full justify-around '>
        {/* card  */}
        {Object.keys(serviceDetails).map((key) => (
          <div key={key}
          className="group relative cursor-pointer overflow-hidden bg-white p-4  pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
          ...
          <div className="relative z-10 mx-auto max-w-md">
            <div className='flex items-center  '>
              ...
              <p className='ml-2 text-lg text-nowrap  font-bold text-gray-700  group-hover:text-white/90'>{serviceDetails[key].serviceTitle}</p>
            </div>
              <div
