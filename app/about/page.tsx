...
<span className="bg-primary text-4xl font-bold p-4 text-white">ABOUT CAPABLE SERVICE</span>
</div>
{/* about  */}
<div className="text-gray-600 body-font ">
    <div className="container mx-auto flex md:px-24 md:py-10 md:flex-row flex-col items-center">
        <div
            className="lg:flex-grow mt-5 md:mt-0   md:w-1.5/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-cente w-1/2">
        ...
        <div className="lg:max-w-lg lg:w-full mb-5 md:mb-0 md:w-1/2 w-3/6">
            <img className="object-cover object-center rounded" alt="hero" src="https://img.freepik.com/free-vector/ventilation-system-abstract-concept-vector-illustration-mechanical-ventilation-airing-cooling-system-maintenance-exhaust-fan-new-air-flow-exchange-improve-air-quality-abstract-metaphor_335657-5754.jpg"/>
        </div>
    </div>
</div>
</div>
